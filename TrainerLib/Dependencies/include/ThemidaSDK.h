...
#else
#define CHECK_PROTECTION(a, b) a = b;
#define CHECK_CODE_INTEGRITY(a, b) a = b;
...
#define VM_SLOW_START VM_DOLPHIN_RED_START
#define VM_SLOW_END VM_DOLPHIN_RED_END
#define VM_FAST_START VM_DOLPHIN_WHITE_START
#define VM_FAST_END VM_DOLPHIN_WHITE_END
